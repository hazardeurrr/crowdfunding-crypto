...
<p>These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and BlockBoosted SAS ("Company," “we," “us," or “our”), concerning your access to and use of the https://blockboosted.com website and all its subdomains (such as https://app.blockboosted.com) as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto; including without limitation using our services to view, explore, create and participate in fundraising campaigns and use our tools, at your own discretion, to connect directly with others to take part in a fundraising campaign on public blockchains (collectively, the “Site”). “Fundraising campaigns” in these Terms means a pool with a certain duration available on a blockchain (such as the BNB Smart Chain), which uses a smart contract to collect donations in cryptocurrencies given by backers. 
<br></br>(V1) refers to Version 1 of the platform, while <br></br>(V2) refers to Version 2 of the platform.
<br></br><br></br>
...
<br></br>BlockBoosted is not a party to any agreement between any users. You bear full responsibility for verifying the identity, legitimacy, and authenticity of campaigns that you take part in from third-party sellers using the Site and we make no claims about the identity, legitimacy, functionality, or authenticity of users or campaigns (and any content associated with such campaigns) visible on the Site.
<br></br><br></br>
Supplemental terms and conditions or documents that may be posted on the Site from time to time are hereby expressly incorporated herein by reference. We reserve the right, in our sole discretion, to make changes or modifications to these Terms of Use from time to time. Please ensure that you check the applicable Terms every time you use our Site so that you understand which Terms apply.
...
<li>Making self or fakes donations on a campaign to improve its awareness or abusing of the reward system;</li>
<li>Use the Site for any illegal or unauthorized purpose, including creating or displaying illegal content, or encouraging or promoting any activity that violates the Terms & Conditions of the Site.</li>
<li>Use the Site in any manner that could interfere with, disrupt, negatively affect or inhibit other users from fully enjoying the Site.</li>
</ul></p>
...
<h2>6. FUNDRAISING CAMPAIGNS & DONATIONS</h2>

<h5>Campaign contract creation</h5>
<p>When you create a campaign, you will interact with our “factory” smart contract. This will create a new instance of our “campaign” smart contract that will be associated with your campaign. We do not have the hand on this smart contract : it is public on the blockchain; has its own address and everyone can interact with it. We provide on our Site an easy way to interact with it.
</p>

<h5>Donating to a campaign</h5>
<p>Users can donate to a campaign interacting with the smart contract associated with it through a dedicated function. They should do so on the Site on the checkout page of the campaign, accessible by the “Back this campaign” button on the campaign’s page, or by selecting any of the reward tier available.
<br></br>Notice that no refund of any kind will be possible on the Site once you have backed the campaign.
<br></br><br></br>
...
<br></br>(V1) Each user has the same “like” weight.
<br></br>(V2) The weight of the “like” depends on the amount of BBST tokens they possess. The more tokens, the more heavy the “like” is.
</p>

<h5>Campaign realization</h5>
<p>From the end of the campaign, the campaign creator will be able to withdraw the amount raised  - i.e. the balance on the associated smart contract - interacting with it through a dedicated function that can be called on the Site directly on the campaign’s page (“Withdraw” button). 
<br></br>If a platform fee is applicable, it will be taken during the withdrawal process automatically.
<br></br>(V1) We do not take any platform fee.
<br></br>(V2) For campaigns held in BBST, we do not take any fee. Otherwise, a 3.5% platform fee will apply.
<br></br><br></br>
...
<h5>
Reward system</h5>
<p>Every donation made through the Site interface to a campaign registers you into the rewards system. Rewards are distributed every week among the users of the Site, according to their donations and limited to a maximum amount per user and per week. We reserve the right to modify at every moment the amount of rewards given per week without prior notification. Note that any donation not made through our UI may not imply a registration in our reward system.
<br></br>Rewards will be given in BBST Token, and balances will be updated at the beginning of every week (UTC timezone).
<br></br>(V1) You won’t be able to claim your rewards in V1, as BBST Token is not issued yet. However, balances will be updated when you make a donation, and you will be able to claim your rewards when V2 launches : rewards will be retroactive.
</p>
...
<h5>Identification of the publisher</h5>
<p>Users are informed that the Site is published by BLOCKBOOSTED SAS, a simplified joint-stock company (SAS) with a share capital of 25 000 Euros, registered in the Nanterre trade and companies register under number 901 342 626, having its head office at 38 rue Victor Hugo, 92800 PUTEAUX, FRANCE. Unique tax identification number (intra-Community VAT number): FR18901342626.
</p>
<h5>Site hoster</h5>
<p>The Site is hosted by the company OVH SAS, whose details are as follows:
 OVH 2 rue Kellermann 59100 Roubaix</p>
<h5>Contact for any claims concerning the Site and/or its content</h5>
<p>The contact email for any claims concerning the Site and/or its Content is contact@blockboosted.com</p>
...
<br></br><br></br>
BlockBoosted SAS<br></br>
38 Rue Victor Hugo<br></br>
Puteaux, Hauts-de-Seine 92800<br></br>
France<br></br>
contact@blockboosted.com<br></br>
</p>
                </div>
            </div>
